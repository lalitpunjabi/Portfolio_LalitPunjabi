      ...
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <a href="#" className="font-bold text-xl text-text-primary inline-block mb-2 text-gradient-accent tracking-wide">
              Lalit Punjabi
            </a>
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="p-2.5 border border-color rounded-full text-text-secondary hover:text-text-primary hover:border-text-primary hover:bg-bg-tertiary transition-all"
              aria-label="GitHub"
            >
              <Github size={20} />
            </a>
        ...
        <div className="mt-8 pt-6 border-t border-color flex flex-col md:flex-row justify-between items-center text-sm text-secondary">
          <p>&copy; {new Date().getFullYear()} Lalit Punjabi. All rights reserved.</p>
